 ...
 *  ============================================================================
 * 
 * 此插件需要YEP\u MessageCore。
 * 确保此插件位于插件列表中的YEP\u MessageCore下。
 * 
 * 控制消息速度的选项在RPG中非常常见。
 * 玩家可以输入任何他们想要的文本选项，或者
 * 如果他们愿意，立即显示文本！此插件将添加
 * “信息速度”选项进入您的选项菜单供玩家调整！它
 * 速度从0（最慢）到10（最快），甚至达到“11”级
 * 瞬间的感觉！
 * 
 *  ============================================================================
 * 选项核心设置-添加新选项
 *  ============================================================================
 * 
 * 如果您使用的是YEP\u OptionsCore.js，则可以使用此选项添加新选项
 * 插件。以下是您可以使用的代码/参数设置。
 * 
 *  ---------
 * 设置：
