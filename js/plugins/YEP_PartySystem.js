 ...
 * 舒适的方式。
 * 
 * 如果您正在使用YEP\u BattleEngineCore.js并希望启用party
 * 在战斗中切换，把这个插件放在YEP\u BattleEngineCore.js下
 * 插件的列表。
 * 
 * 这个插件是即插即用的。你只要打开它
 * 根据您的喜好更改参数。
 ...
 *
 * Plugin Command:
 *   ShowBattleFormation    - 在战斗中显示“编队”指挥。
 *   HideBattleFormation    - 在战斗中隐藏“编队”命令。
 *   EnableBattleFormation  - 在战斗中启用“编队”命令。
 *   DisableBattleFormation - 在战斗中禁用“编队”命令。
 *
 *   LockActor 3          - 锁定演员3。
 *   LockActor 4 5 6      - 锁定参与者4、5和6。
 *   UnlockActor 3        - 解锁演员3。
 *   UnlockActor 4 5 6    - 解锁演员4、5和6。
 *                        * 锁定的演员不能移出当前角色
 *                           必须在党内。
 *
 *   RequireActor 3       - 玩家必须有演员3参加聚会。
 *   RequireActor 4 5 6   - 玩家必须有演员4，5和6在一方。
 *   UnrequireActor 3     - 玩家不再需要演员3参加派对。
 *   UnrequireActor 4 5 6 - 玩家不再需要演员4，5，6在党。
 *                                        必须有必要的演员参加才能
 *                                        玩家可以退出聚会菜单。
 * 
 *   ChangePartyMax 5     - 将“最大聚会大小”更改为5。
 *
 * ============================================================================
 * Changelog
 * ============================================================================
