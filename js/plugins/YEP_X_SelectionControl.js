 ...
 *
 * 当选择目标时，MV默认是从所有存活敌人，所有友军或者死亡友军中选择。然而
 * 有时候我们希望我们可以从特定的列表里面选择。这个目标核心插件的拓展插件
 * 可以让你自由的设置选择列表
 *
 ...
 *   targets the user itself.此战斗者不可被此类攻击选中
 *
 ...
 *   to the item with the highest ID.此战斗者不可被特定物品选中
 *
 ...
 *   given to the skill with the highest ID.此战斗者不可被特定技能选中
 *
 ...
 * following notetag setup:设置特殊情况
 *
 * ---
 *
 * Skill and Item Notetags:
 ...
 *   associated condition with it.自定义设置语句。这将覆盖插件的默认设置
 *
 * ---
 *
 * Conditions:
 ...
 * conditions.需要配合YEP_RowFormation.js，战斗者可以被任何排选中
 *
 * ---
 *
 * Back Row Only
 ...
 * 需要配合YEP_RowFormation.js，战斗者只能被后排选中，此处后排指存活战
 * 斗成员的最后一排
 *
 * ---
 *
 ...
 * conflict with the other 'Row Only' select conditions.
 * 需要配合YEP_RowFormation.js，战斗者只能被前排选中，此处前排指存活战斗
 * 成员的第一排
 *
 * ---
 *
 ...
 * conditions.需要配合YEP_RowFormation.js，战斗者只能被特定排选中
 *
 * ---
 *
 * Row x Max
 ...
 * run an eval check against that parameter owned by the target.检查基础参数
 *
 * ---
 *
 * State: x
 ...
 * target is not a valid target for selection.检查状态
 *
 * ---
 *
 * Not State: x
 ...
 * the target is not a valid target for selection.检查是否不在状态
 *
 * ---
 *
 * Not User
 ...
 * make custom selection conditions for skills and items.拓展模式
 *
 * Skill and Item Notetags:
 *
 ...
 *   other selection conditions must pass, too.例句
 *
 * ============================================================================
 * Changelog
 * ============================================================================
