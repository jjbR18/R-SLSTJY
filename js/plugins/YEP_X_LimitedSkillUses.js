 ...
 *
 * 这是技能核心插件拓展插件，能够让你限制一些技能的使用次数。
 * 添加了一个不同的技能类型，并且平衡了技能使用的限制次数
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 ...
 *
 *   <Unlimited Use>
 *   如果你开启了“限制所有技能”选项，那么这个将会让技能不受限制使用，
 *   如果你使用了这个标签，它将会重写你的限制设置
 *
 *   <Limit Uses: x>
