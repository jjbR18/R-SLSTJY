 ...
 *  ============================================================================
 * 
 * 这个插件需要有自动助理。确保此插件位于插件列表中的YEP\u AutoPassiveStates下。
 * 
 * 被动光环效果在许多带有RPG元素的在线多人游戏中很常见。当一个战士能发出光环时，它也会影响附近的其他战士，无论是盟友还是敌人。这个插件将允许国家产生光环效果为其他成员，对手，或专门为演员和/或敌方。
 * 
 *  ============================================================================
 * 便签
 *  ============================================================================
 ...
 * 使用以下注释标签使一个状态产生光环。
 * 
 *   *注意：影响活动成员的NoteTag将影响至少有1 HP且不受死亡状态影响
 * 的成员。即使他们是不朽的，如果他们的生命值为0，他们也不会受到
 * 活灵气效果的影响，以免与死灵气效果冲突。
 * 
 *   *注意：影响死亡成员的注释标签将影响受死亡状态影响的成员，或者
 * 如果死亡成员的生命值为0。死亡成员有1生命值或不再受死亡状态
 * 影响时，他们将不再受仅死亡光环效果的影响。
 *
 * 状态注释标签：
 *
 *   <Ally Aura: x>
