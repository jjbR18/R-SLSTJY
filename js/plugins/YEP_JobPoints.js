 ...
 *  ============================================================================
 * 
 * 这个插件本身不会改变任何主要的游戏功能，但是，
 * 它与其他使用这个插件的插件结合使用
 * 如果你决定在游戏中加入工作点数。
 * 
 * 当获得工作点数时，它们将被分配给演员当前的班级。如果
 * 演员们要换班了，那么作业点就改成了
 * 那个班的工作点，直到恢复。
 * 
 *  ============================================================================
 ...
 *  ============================================================================
 * 
 * 如果你安装了YEP\u VictoryAfter插件并希望使用
 * 在jpwindows中，将这个插件放在比YEP\u更低的位置
 * 插件管理器。
 * 
 * 之后，如果您想定义JP窗口在
 * 在某一点上，插入“JP”，而不是插件自动执行
 * 在您想要
 * 显示JP窗口。
 * 
 *  ============================================================================
