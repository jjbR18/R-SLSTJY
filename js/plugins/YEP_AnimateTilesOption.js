 ...
 *
 * 有些玩家在接近动画图块时会感到延迟。
 * 这是因为动画图块在不断进行绘画、删除、重绘的操作。
 * 不幸的是，Pixi2渲染引擎会泄露大量的内存。
 * 在移动设备上或者配置较弱的电脑上，内存不足会使游戏崩溃。
 * 这个选项可以让玩家在设置菜单里开启或者关闭动画图块的功能。
 *
 * 对于使用默认的自动设置的人，将会在移动设备和浏览器网站
 * 关闭动画图块功能，在本地计算机会打开
 *
 * ============================================================================
 * 选项核心设置-添加新选项
