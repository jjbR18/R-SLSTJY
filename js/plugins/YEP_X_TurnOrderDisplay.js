 ...
 *  ============================================================================
 * 
 * 此插件需要YEP\u BattleEngineCore。确保此插件位于
 * 在插件列表的YEP\u BattleEngineCore下。
 * 
 * 对于基于回合的战斗系统，如DTB（默认回合战斗），允许
 * 玩家在视觉上看到的转弯顺序可以增加更多的深度
 * 作战系统。这个插件将添加一个显示转弯的图标
 * 玩家一方和敌方在一个角落内的命令
 * 屏幕（可修改）。
 * 
 * 注意！这个插件不适用于基于滴答声的战斗系统，如ATB或
 * CTB！它专门用于基于回合的作战系统。
 * 
 *  ============================================================================
 * 便签
 ...
 *   - 这将演员/敌人使用的边框颜色设置为文本颜色x。
 *
 *   <Turn Order Background Color: x>
 *   - 这将演员/敌人使用的背景色设置为文本颜色x。
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
 *
 * 仅演员注释标签：
 ...
 * - 这样设置，如果参与者是一个特定的类，那么参与者将获得一个特定的图标，
 * 用于显示转弯顺序。如果参与者是类x，它将接收图标y。
 *
 *   <Hero Turn Order Icon: x>
 *   <Warrior Turn Order Icon: x>
 *   <Mage Turn Order Icon: x>
 *   <Priest Turn Order Icon: x>
 * - 如果您喜欢使用名称而不是类ID，则可以使用上述notetag格式。
 * 如果actor是命名类，它将接收图标x。
 * 如果您有多个同名的类，则ID最高的类将获得优先级。
 *
 * ============================================================================
 * 插件命令
 *  ============================================================================
