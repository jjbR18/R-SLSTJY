 ...
 *
 * 附加增强系统是物品核心插件的拓展插件。他可以让你的装备能够镶嵌
 * 附加不同的能力，你可以自定义每个独立物品。这些镶嵌口可以设置
 * 独特的分类，我们可以通过这些改变基础参数，增加技能，调整抗性等等
 *
 * ============================================================================
 * 便签
 * ============================================================================
 ...
 * 
 * ②物品那里设置镶嵌的宝石。
 * 例如：设置一个攻击宝石，效果是攻击+10，种类是宝石。
 * 然后就可以镶嵌到宝石槽位上，但镶嵌不到魔器上。
 * <Augment Attach: 宝石>
 * ATK: +10
 * </Augment Attach: 宝石>
 * 其他的增加效果可以看下方，好了☁️注解 结束！
 * 
 * ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
 * 
 * 您可以使用以下注释标签来设置增强如何在游戏中工作并影响设备。
 * 
*武器和盔甲标签：
 *
 *   <Augment Slots>
 ...
 *    augment effect
 *   </Augment: type>
 *   将物品改造为非独立物品，这些物品可以用来镶嵌在武器护甲上。
 * 这个标签可以用来设置镶嵌后的属性并且脱离后也会保留状态。
 *
 *   <Augment Attach: type>
 *    augment effect
 *    augment effect
 ...
 *   </Augment Detach: type>
 *   将物品改造为非独立物品，这些物品可以用来镶嵌在武器护甲上。
 * 这个标签可以用来设置脱离镶嵌后的属性，注意在镶嵌时不会保留状态。
 *
 * ============================================================================
