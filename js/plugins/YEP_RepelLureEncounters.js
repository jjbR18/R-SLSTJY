 ...
 * @text 诱饵过期事件
 * @desc 这是诱惑消失时要运行的常见事件的ID。保留为0以不运行公共事件。
 * @default 0
 *
 * @param Lure Rate
 * @text 增强率
 * @desc 这是在诱饵的作用下使遭遇步幅膨胀的速率。
 * @default 2.00
 *
 * @param Lure Flat
 * @text 诱饵扁平
 * @desc 如果受到诱饵的影响，这是用来减少遭遇步数的单位值。
 * @default 1
 *
 * @help
 * ============================================================================
 ...
 * ============================================================================
 *
 * 在MV里面，你可以选择随机遇敌或者完全不遇敌。
 * 但是如果你想制作某个系统在一定步数内可以抵制遇敌或者提高遇敌概率，
 * 这是很难得。这个插件允许你来自定义遇敌概率
 *
 * ============================================================================
 * Instructions
 * ============================================================================
 *
 * 在这个插件参数里面，抵御变量和遇敌变量参数是绑定的。
 * 当这些变量在游戏内调整后，他们的效果也会即时调整。
 * 当变量值低于0时，他们将会自动调整为1。
 *
 * ---
 *
