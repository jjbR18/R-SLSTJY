 ...
 * @text 隐藏变量
 * @desc 在游戏开始时从状态菜单中隐藏这些变量。用空格分隔每个变量ID。
 * Hide these variables from the status menu at the start
 ...
 * ============================================================================
 *
 * 这个插件需要身份菜单核心插件。你想要展示特有的游戏变量进入你的
 * 角色身份菜单吗？现在你可以了！这些变量可以来自全局变量或者
 * 每个角色的独有变量。在参数内找到的全局变量都可以被列举。
 * 角色备注框里里设置的变量将会展示在角色栏
 * 
 * 这个插件需要YEP_StatusMenuCore，确保它放在YEP_StatusMenuCore下面
 * 
 * 插件让你能够把变量放入身份菜单的特殊页显示出来。
 * 这些变量可以来自全局变量或者每个角色的独有变量。在参数内找到的
 * 全局变量都可以被列举。角色备注框里里设置的变量将会展示在角色栏
 * 
 * 如果你想把角色变量栏放入身份菜单，请把‘Variables’ 放入身
 * 份菜单核心插件命令参数栏，否则，将会出现在‘Custom’栏
 *
 * ============================================================================
 * Notetags
 * ============================================================================
