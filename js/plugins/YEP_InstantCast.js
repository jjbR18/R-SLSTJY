 ...
 * 
 * 当行动拥有立即释放特性时，这个行动将会在这个点立即使用而不用等待回合
 * 来开始。使用完后，玩家可以继续使用其他行动。这就可以让你的战斗更加有
 * 深度。如果你的角色有多个行动，立即释放这个行动必须是第一个技能
 * 并且不在战斗序列内。
 * 
 * 在事件中，如果敌方使用立即释放技能，一旦敌方回合开始，
 * 它会立即释放并且后开始其他技能
 *
 * 这个插件通常用来开启技能限制
 *
 ...
 *   <Instant>
 *   <Instant Cast>
 *   这2个标签是一样的。可以让第一个行动使用时是立即释放，
 *   当敌方使用时，这将会让敌方可以继续开始下一个行动。
 *
 * Actor, Class, Enemy, Weapon, Armor, and State Notetags:
 *   <Instant Skill: x>
 *   <Instant Skill: x, x, x>
 *   <Instant Skill: x to y>
 *   如果特定角色、敌方、职业或者装备特点武器等，甚至特点状态，
 *   这个技能就会被立即释放
 *
 *   <Instant Item: x>
 *   <Instant Item: x, x, x>
