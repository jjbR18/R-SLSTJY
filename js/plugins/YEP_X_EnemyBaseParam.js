 ...
 * 
 * 对于那些想用更公式化的方法来计算的人来说
 * 敌方参数类似于基类参数做什么的，这个插件
 * 将允许你用类似的方法来确定敌人的参数。这个可以用
 * 以玩家等级数据为基础，甚至调整每个敌人的等级
 * 拥有个人数据。
 * 
 *  ============================================================================
 * 便签
 *  ============================================================================
 * 
 * 你可以用这个便签把敌人的数据建立在一个类的基础上。
 * 
 * 敌方便签：
 *
 *   <Base Parameters on Class: x>
 *   - 这将基于除“exp”和“gold”以外的所有参数。
 *   * 注意：这将优先于自定义参数。
 *
 *   <Base stat Parameter on Class: x>
 *   - 这将基于类x的特定'stat'参数。替换“stat”
 * 使用“maxhp”、“maxmp”、“atk”、“def”、“mat”、“mdf”、“agi”或“luk”。
 *   * 注意：这将优先于自定义参数。
 *
 * ============================================================================
