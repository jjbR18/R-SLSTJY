 ...
 * @text 图片1 点击
 * @desc 单击具有此ID的图片时运行此常见事件。
 * 如果没有常见事件，请将此值保留为0。
 * @default 0
 *
 * @param Picture 1 Repeat
 * @text 图片1 重复
 * @desc 当每6帧保存一张具有此ID的图片时，运行此常见事件。
 * 如果没有常见事件，请将此值保留为0。
 * @default 0
 *
 * @param Picture 1 Hold
 * @text 图片1 单击按住
 * @desc 单击并按住具有此ID的图片时运行此常见事件。
 * 如果没有常见事件，请将此值保留为0。
 * @default 0
 *
 * @param Picture 1 Release
 * @text 图1 释放
 * @desc 释放具有此ID的图片时运行此常见事件。
 * 如果没有常见事件，请将此值保留为0。
 * @default 0
 *
 * @param ---Picture 2---
 ...
 * ============================================================================
 *
 * 图片不仅仅可以作为图像存在你的游戏，还可以实现很多功能。
 * 他们可以用来做界面元素。
 * 可目前他们还不能在鼠标点击时作为公共事件执行。
 * 使用这个插件，图片可以绑定公共事件，当鼠标点击或者触摸时执行
 *
 * ============================================================================
 * Instructions
 * ============================================================================
 *
 * 在插件参数里，你可以绑定图片的事件ID，总共图片上限100张。
 * 只要图片有值，他就会用于事件。这里有4种触发情况:
 *
 * ---
 *
 * - CLICK
 ...
 *   ShowPictureCommonEvents  显示和隐藏图片事件
