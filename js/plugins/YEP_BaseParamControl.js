 ...
 * ============================================================================
 *
 * 基础参数，例如最大生命值，最大魔法值，攻击，防御，魔攻，魔防，
 * 速度，幸运等，发挥了非常重要的作用。
 * 然而缺乏必要的调整来开发他们。这个插件允许你更好地调节使用
 *
 * 注意：如果你使用了Core Engine，并且改变了参数设置，
 * 当你把插件放Core Engine下面时，在这个插件会覆盖原有设定
 *
 * ============================================================================
