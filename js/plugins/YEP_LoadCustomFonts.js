...
//=============================================================================
 /*:
 * @plugindesc v1.00 载入自定义字体☁️
 * @author Yanfly Engine Plugins
 *
 * @param Font Filenames
 * @text 字体文件名
 * @desc 这些是要从项目的/fonts/文件夹加载的字体的完整文件名。分别用，
 * @default cc-wild-words.ttf, ds-pixel-cyr.ttf
 *
 * @param Font Families
 * @text 字体系列名
 * @desc 字体的字体系列名称。保持与上面参数相同的顺序。分别用，
 ...
 * ============================================================================
 *
 * 对于那些使用自定义字体的人，你也许注意到并不是所有的字体都可以在游戏
 * 加载完毕后被加载。这个插件可以让你把你的字体放入字体文件夹并且在游戏
 * 开始时加载它们
 *
