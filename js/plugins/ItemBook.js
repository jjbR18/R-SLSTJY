 ...
 *
 * 插件命令:
 *   ItemBook open            # 打开物品图鉴
 *   ItemBook add weapon 3    # 获得 武器#3 图鉴
 *   ItemBook add armor 4     # 获得 护甲#4 图鉴
 *   ItemBook remove armor 5  # 移除 护甲#5 图鉴
 *   ItemBook remove item 6   # 移除 物品#6 图鉴
 *   ItemBook complete        # 获得 所有 物品图鉴
 *   ItemBook clear           # 移除 所有 物品图鉴
 *
 * 数据库-敌人-备注:
 *   <book:no>                # 此物品不会出现在物品图鉴中
 */
