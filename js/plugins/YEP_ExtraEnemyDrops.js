 ...
 * ============================================================================
 *
 * MV限制了敌方最多掉落3样物品以及严格的掉落概率。这个插件可以让你提高掉
 * 落数量，甚至可以设置条件掉落
 *
 * ============================================================================
 ...
 *   <Drop Potion: x%>
 *   <Drop Short Sword: x%>
 *   <Drop Feather Cap: x%>   采用名字设置掉落物品及概率
 ...
 *    condition: +y%
 *    condition: -y%
 *   </Conditional Armor x Drop>   设置特定条件下掉落物品及概率
 ...
 *    condition: +y%
 *    condition: -y%
 *   </Conditional Named Drop>   采用名字设置特定条件下掉落物品及概率
 ...
 * are being calculated and made and runs it against an eval check.存活队员
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * in the order of items, weapons, and then armor.对比特定物品数量
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * are being calculated and made and runs it against an 对比死亡人数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * This effect requires the Battle Engine Core.死亡回合数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * then the condition is met.对比插入代码
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * order of skills then items.对比最后使用的物品或者技能
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * the drops are being calculated and made and runs it 对比队伍成员数量
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * RANDOM X%
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * This condition has a random x% chance to pass.对比随机概率
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * can also replace x with the name of the item.对比敌方承受状态次数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * You can also replace x with the name of the state.对比敌方受物品攻击次数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * You can also replace x with the name of the skill 对比敌方受技能攻击次数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * SWITCH X OFF
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * Replace X with a switch ID. If switch X is ON or OFF, the co对比开关
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 * gone on for until the time the drops have been made.对比回合数
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * Example:   Turn > 5: +10%
 *            Turn === 5: +20%
 *            Turn <= 4: +30%
 ...
 * variable's value to see if it meets the conditions.对比变量
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
