 ...
 * ============================================================================
 *
 * 这个插件需要YEP_GridFreeDoodads，
 * 确保这个插件在YEP_GridFreeDoodads下面
 *
 * 这个插件可以让你在摆件放置编辑器里面设置更多细节。
 * 你可以设置摆件的色调，出现
 * 
 * ============================================================================
 ...
 * ============================================================================
 *
 * 这个色调是摆件图片的色调，可以用来展示不同颜色等，
 * 这就意味着你不需要制作很多资源就可以设置更多摆件，
 * 而且相对于系统色调来说内存占用会更小。
 *
 * ============================================================================
 ...
 * ============================================================================
 *
 * 如果你希望摆件可以根据成员是否在队伍内来出现或隐藏，
 * 你可以通过设置来做到。
 * 你可以设置当某个成员加入时，摆件出现或者消失在房间内。
 * 这个条件针对的是队伍成员是否在活动队伍或者轮换列表里，
 * 他们在这里没有区别。
 *
 * ============================================================================
 ...
 * ============================================================================
 *
 * 如果你希望摆件可以根据开关情况来出现或隐藏，你也可以通过设置来做到。
 * 你可以为每一个摆件设置多个开关。当所有开关匹配时才会触发。
 * 如果某个摆件需要开关是打开，而目前是关闭状态，
 * 那么他会持续隐藏直到开关打开。反之亦然。
 * 如果某个摆件需要开关是关闭，而目前是开启状态，
 * 那么他会持续显示直到开关关闭。
 *
 * ============================================================================
 * Changelog
