 ...
 * ============================================================================
 *
 * 公共事件菜单允许制作自定义菜单设置，当你使用它时，
 * 你可以选择你希望执行的公共事件列表产生一个菜单。
 * 这个公共事件菜单允许你显示帮助信息，
 * 图片和的公共事件列表产生一个菜单。
 * 这个公共事件菜单允许你显示帮助信息，图片。
 *
 * ============================================================================
 * Instructions
 * ============================================================================
 *
 * 这个公共事件菜单可以通过插件命令制作。你可以创建不同的菜单列表。
 * 下面是一些例子。
 *
 ...
 * ============================================================================
 *
 * MV中公共事件并没有他们的标签栏，所以我们使用事件中的注释命令。
 * 你可以使用下面的语句来简便的创建菜单:
 *
 ...
 *
 *   OpenCommonEventMenu
 *   - 打开公共事件菜单。如果你使用了 Battle Engine Core，
 *      你可以在战斗中打开它。
 *
 *   ---
 *
 ...
 *   这些插件命令可以调整菜单位置，宽高，透明度，列数。
 *   确保这些插件命令在OpenCommonEventMenu命令之前
 *
 *   ---
 *
