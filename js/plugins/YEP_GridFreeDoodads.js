 ...
 * ============================================================================
 *
 * 这个插件需要MV1.3.0以上的版本，请检查你的rpg_core.js文件内部，
 * 是否符合要求，如果不符合，请提前升级
 * 在RPG Maker MV里面，图块被用来做地图。
 * 一般图块A型被用来画地面，图块B型到E型负责添加摆设物件。
 * 但是在MV里面，摆件被限定在网格上并且感觉不自然。
 ...
 * ============================================================================
 *
 * 为了把摆件放入你的游戏，需要现在测试模式载入你的游戏。
 * 你可以在MV里面来进入，或者用快捷键Ctrl+R
 *
 * 一旦你载入了地图，你可以按F10键来开启编辑器，
 * 在这里你可以选择‘Place Doodads来开始放置
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
 *
 * ---Main Menu---
 ...
 *
 *   Hue 设置外表色彩，这需要占用大量资源，
 *   如果你需要输出为移动端，建议不要使用不同的色彩外表
 ...
 *   3.当命名的时候，需要采用[AxB]的模式，A为横向数量，B为竖向数量。
 * 一个摆件拥有3个横向单元2个竖向单元，例如Torch [3×2].png
